...
const Trancports =()=>{
   ...
   const handelLeft =()=>{
      ...
      if(count === 18){
       ...
       setCount(count - 1);
       fetch(`http://swapi.dev/api/vehicles/${count}`)
    ...
    <div class="card">
      ...
      <div class="card-image">
        <img style={{height:500}} src="https://i.ytimg.com/vi/n_JW4mggioA/maxresdefault.jpg" />
      ...
      <div class="card-action">
        <a ><span  className="badge  #ffffff white-text #455a64 blue-grey darken-2"> Класс : {data.vehicle_class} </span></a>
        <a class="btn-floating pulse large  #455a64 blue-grey darken-2 "><i class="material-icons ">priority_high</i></a>
      </div>
